# utils/guided_sampler_native.py - Simple fix
import torch
...
class NativeGuidedSampler:
    ...
    def sample(self, batch_size=1):
        ...
        # Use the model's sampling_timesteps (250) instead of num_timesteps (1000)
        timesteps = self.diffusion_1.sampling_timesteps
        
        # Reverse through timesteps - this will use DDIM with 250 steps
